import { s as S, t as r, k as s, L as P, h as q, p as i, b as u, e as c, E as l } from "./index-3cbb0504.js";
const R = 1, g = 33, $ = 34, b = 35, v = 36, m = /* @__PURE__ */ new l((O) => {
  let e = O.pos;
  for (; ; ) {
    if (O.next == 10) {
      O.advance();
...
function n(O, e, a) {
  return new l((t) => {
    ...
    for (; t.next != O && t.next >= 0 && (a || t.next != 38 && (t.next != 123 || t.peek(1) != 123)); )
      t.advance();
    t.pos > Q && t.acceptToken(e);
  });
}
const x = /* @__PURE__ */ n(39, g, !1), W = /* @__PURE__ */ n(34, $, !1), d = /* @__PURE__ */ n(39, b, !0), C = /* @__PURE__ */ n(34, v, !0), T = /* @__PURE__ */ c.deserialize({
  version: 14,
  ...
  tokenizers: [m, x, W, d, C, 0, 1],
  topRules: { Content: [0, 2], Attribute: [1, 9] },
  tokenPrec: 0
}), f = /* @__PURE__ */ s.parser.configure({
  top: "SingleExpression"
}), p = /* @__PURE__ */ T.configure({
  props: [
    /* @__PURE__ */ S({
      Text: r.content,
...
}), o = { parser: f }, V = { parser: s.parser }, A = /* @__PURE__ */ p.configure({
  wrap: /* @__PURE__ */ i((O, e) => O.name == "InterpolationContent" ? o : null)
}), U = /* @__PURE__ */ p.configure({
  wrap: /* @__PURE__ */ i((O, e) => {
    var a;
  ...
  top: "Attribute"
}), w = { parser: A }, y = { parser: U }, E = /* @__PURE__ */ P.define({
  name: "angular",
  parser: /* @__PURE__ */ q.parser.configure({
    wrap: /* @__PURE__ */ i(N)
  }),
  languageData: {
...
function N(O, e) {
  switch (O.name) {
    case "Attribute":
      return /^[*#(\[]|\{\{/.test(e.read(O.from, O.to)) ? y : null;
    case "Text":
      return w;
  }
  return null;
